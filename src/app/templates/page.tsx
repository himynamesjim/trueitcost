      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 64px)' }}>
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Pre-built templates to jumpstart your IT infrastructure projects
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-12">
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-md mx-auto">
              We're building a library of pre-configured solution templates to help you get started faster. Check back soon!
            </p>
