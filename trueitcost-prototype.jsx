...
export default function TrueITCostApp() {
  ...
  const [savedConfigs, setSavedConfigs] = useState([
    { id: 1, name: "Main Conference Room - Teams", category: "collaboration", date: "Feb 10, 2026", status: "Complete" },
    { id: 2, name: "UCaaS Migration - 45 Users", category: "ucaas", date: "Feb 8, 2026", status: "Draft" }
  ]);
  ...
  const handleNext = () => {
    if (currentStep < category.fields.length - 1) {
      ...
      <div style={{
        ...
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .saved-row:hover { background: rgba(255,255,255,0.04) !important; }
        `}</style>
        ...
        {/* Header */}
        <header style={{ padding: "20px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(255,255,255,0.06)", animation: "fadeIn 0.6s ease" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "linear-gradient(135deg, #0ea5e9, #8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px", fontWeight: 700, color: "#fff" }}>T</div>
            <span style={{ fontSize: "18px", fontWeight: 600, letterSpacing: "-0.02em" }}>TrueITCost</span>
            <span style={{ fontSize: "11px", padding: "2px 8px", borderRadius: "10px", background: "rgba(14,165,233,0.15)", color: "#38bdf8", fontWeight: 500, fontFamily: "'DM Mono', monospace" }}>AI Architect</span>
          </div>
          <div style={{ display: "flex", gap: "8px" }}>
            <button style={{ padding: "8px 16px", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.1)", background: "transparent", color: "#94a3b8", fontSize: "13px", cursor: "pointer", fontFamily: "inherit" }}>My Projects</button>
            <button style={{ padding: "8px 16px", borderRadius: "8px", border: "none", background: "linear-gradient(135deg, #0ea5e9, #0284c7)", color: "#fff", fontSize: "13px", cursor: "pointer", fontWeight: 500, fontFamily: "inherit" }}>Sign In</button>
          </div>
        </header>
        ...
        <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "60px 40px" }}>
          ...
          <div style={{ animation: "slideUp 0.8s ease 0.4s both" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              <h2 style={{ fontSize: "13px", fontWeight: 500, color: "#475569", textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: "'DM Mono', monospace" }}>Saved Configurations</h2>
              <span style={{ fontSize: "12px", color: "#475569" }}>2 projects</span>
            </div>
            <div style={{ borderRadius: "12px", border: "1px solid rgba(255,255,255,0.06)", overflow: "hidden" }}>
              {savedConfigs.map(config => {
                ...
                return (
                  <div key={config.id} className="saved-row" style={{
                    padding: "16px 20px",
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: "14px", fontWeight: 500 }}>{config.name}</div>
                      <div style={{ fontSize: "12px", color: "#475569" }}>{config.date}</div>
                    </div>
                    <span style={{
                      fontSize: "11px", padding: "3px 10px", borderRadius: "10px", fontFamily: "'DM Mono', monospace",
                      background: config.status === "Complete" ? "rgba(16,185,129,0.1)" : "rgba(245,158,11,0.1)",
                      color: config.status === "Complete" ? "#34d399" : "#fbbf24"
                    }}>
                      {config.status}
                    </span>
                  </div>
